...
public class LocalDiviceFileTest {

	LocalDiviceFile localdiv = new LocalDiviceFile();
	...
	public void testReadFileIntoList() throws IOException {
		...
		List<String> actualList = localdiv.readFileIntoList(TEST_CLASS_LOCAL);
	...
	public void testReadFileIntoString() throws IOException {
		...
		String actuals = localdiv.readFileIntoString(TEST_CLASS_LOCAL);
